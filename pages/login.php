            ...
            <div
                ...
                <div class="login p-5">
                    <div class="title text-center">
                        <h1 class="text-4xl mb-5 text-white">Login Page</h1>
                    </div>
                    <p><?php
                                if(isset($_GET['gagal'])){
                    ...
                    <form action="../controller/login-controller.php" method="post">
                        ...
                        <div class="btn-cta flex justify-center flex-col mt-10">
                            <button type="submit" name="login"
                                class="bg-primary text-center shadow-xl px-10 py-2 rounded-xl text-white text-xl">Login</button>
                            <span class="text-center text-sm text-white italic">Don't have an account? <a
                                    href="register.php" class="text-sm text-white italic">Sign Up</a></span>
                        </div>
                    </form>
                </div>
            </div>
